...
`;var z={lang:"en",position:"bottom-left",offset:[20,20],size:58,backendUrl:"https://newsroom.romiltec.it/api/accessibility"};function ot(e,i){let t=e.getAttribute("data-translate")||i;return!e.hasAttribute("data-translate")&&i&&e.setAttribute("data-translate",t),b(t)}function j(){_.querySelectorAll(".asw-card-title, .asw-translate").forEach(e=>{let i=e.textContent?.trim()||"";e.textContent=ot(e,i)}),_.querySelectorAll("[title]").forEach(e=>{let i=e.getAttribute("title")||"";e.setAttribute("title",ot(e,i))})}function H(e){if(e=String(e||"").toLowerCase(),C.some(i=>i.code===e)||(e="en"),l.lang!==e){l.lang=e;let i=K.querySelector("#asw-language");i&&(i.value=e),j(),g()}}function B(){let e=document.querySelector(".asw-menu");e&&e.classList.toggle("asw-menu--hidden")}function un(e){z?.position?.includes("right")&&(e.style.right="0px",e.style.left="auto")}function st(e,i){let t=e.querySelector(".asw-amount");t&&(t.textContent=`${(i*100).toFixed(0)}%`)}function pn(e){e.innerHTML=C.map(i=>`<option value="${i.code}">${i.label}</option>`).join(""),e.value=l.lang}function gn(e,i){let a=l?.states?.fontSize??1;a+=i.classList.contains("asw-minus")?-.1:.1,a=Math.max(.1,Math.min(2,Number(a.toFixed(2)))),st(e,a),F(a),l.states.fontSize=a,g(),y(e,l)}function fn(e,i){let t=i.dataset.key;if(i.classList.contains("asw-filter")){let n=l.states.activeFilters??[];n=Array.isArray(n)?n:[],n=n.includes(t)?n.filter(r=>r!==t):[...n,t],l.states.activeFilters=n,m(n),g(),v(),y(e,l);return}let a=!l.states[t];l.states[t]=a,v(),g(),y(e,l)}function _n(e,i){i.value=l.states["screen-reader-speed"]?.toString()??"1",i.addEventListener("change",t=>{let a=t.target.value;l.states["screen-reader-speed"]=Number(a),g(),we(Number(a)),y(e,l)})}function mn(e){e.innerHTML=R.map(i=>{let t=l.states["active-profile"]===i.id;return`
    ...
    `}).join(""),e.querySelectorAll(".asw-profile-toggle").forEach(i=>{i.addEventListener("click",function(){let a=i.closest(".asw-profile").getAttribute("data-id");l.states["active-profile"]===a?at(a,l,v,g,null,m):tt(a,l,v,g,null,m)})})}function bn(e,i){e.querySelectorAll(".asw-menu-close").forEach(t=>t.addEventListener("click",B)),e.querySelectorAll(".asw-menu-reset, .asw-menu-reset-footer-btn").forEach(t=>t.addEventListener("click",()=>{se(),N()})),i.querySelectorAll(".asw-plus, .asw-minus").forEach(t=>t.addEventListener("click",()=>gn(i,t))),i.querySelectorAll(".asw-btn").forEach(t=>t.addEventListener("click",()=>fn(i,t)))}function N(){document.querySelector(".asw-menu")?.remove();let e=document.createElement("div");e.innerHTML=`<style>${nt}</style>`+Me;let i=e.querySelector(".asw-menu");un(i),i.querySelector(".content").innerHTML=P($e,"asw-content"),i.querySelector(".tools").innerHTML=P(Qe,"asw-tools"),i.querySelector(".contrast").innerHTML=P(Oe,"asw-filter");let t=Number(l.states?.fontSize)||1;st(i,t),C.some(d=>d.code===l.lang)||(l.lang="en");let a=i.querySelector("#asw-language");pn(a),a.addEventListener("change",d=>{H(d.target.value),N()}),bn(e,i);let n=i.querySelector("#asw-screenreader-speed");n&&_n(i,n);let r=i.querySelector(".asw-profiles");return mn(r),[{selector:".asw-menu-title.asw-translate.main-title",key:"accessibility_menu"},{selector:".asw-card-title.asw-translate.profile-title",key:"accessibility_profiles"},{selector:".asw-card-title.content-adjustments-title",key:"Content Adjustments"},{selector:".asw-card-title.color-adjustments-title",key:"Color Adjustments"},{selector:".asw-card-title.tools-title",key:"Tools"},{selector:".asw-card-screen-reader-speed.asw-translate",key:"screen-reader-speed"},{selector:".asw-label .asw-translate",key:"Adjust Font Size"},{selector:".asw-menu-reset-footer-btn",key:"Reset settings"},{selector:".screen-reader-speed-low",key:"screen_reader_speed_low",title:"Low"},{selector:".screen-reader-speed-normal",key:"screen_reader_speed_normal",title:"Normal"},{selector:".screen-reader-speed-fast",key:"screen_reader_speed_fast",title:"Fast"}].forEach(({selector:d,key:p,title:G})=>{let w=i.querySelector(d);if(w){let A=b(p);w.textContent=A===p&&G?G:A}}),_.appendChild(e),m(l.states.activeFilters??[]),y(i,l),e}window.renderMenu=N;var rt=N;var K;function lt(){K?B():K=rt(),j()}var _;function dt(){_=document.createElement("div"),_.classList.add("asw-container"),_.innerHTML=`<style>${De}</style>${xe}`;let e=_.querySelector(".asw-menu-btn");return Object.assign(e.style,hn()),e?.addEventListener("click",i=>{i.preventDefault(),i.stopPropagation(),i.stopImmediatePropagation(),lt()}),j(),document.body.appendChild(_),_}function hn(){let{position:e="bottom-left",offset:i=[20,20]}=z,[t=20,a=25]=i,n=`calc(50% - 27.5px - ${a}px)`,r=`calc(50% - 27.5px - ${t}px)`;switch(e){case"bottom-right":return{bottom:`${a}px`,right:`${t}px`,left:"auto"};case"top-left":return{top:`${a}px`,left:`${t}px`,bottom:"auto"};case"top-right":return{top:`${a}px`,right:`${t}px`,left:"auto",bottom:"auto"};case"center-left":return{left:`${t}px`,bottom:n};case"center-right":return{right:`${t}px`,left:"auto",bottom:n};case"bottom-center":return{bottom:`${a}px`,left:r};case"top-center":return{top:`${a}px`,bottom:"auto",left:r};default:return{bottom:`${a}px`,left:`${t}px`}}}function re({options:e}){let i=he();return Object.assign(z,e),Object.assign(l,i),E(),dt(),{changeLanguage:H}}function S(e){let i=`data-asw-${e}`,t=document.currentScript;return t?.hasAttribute(i)?t.getAttribute(i):document.querySelector(`[${i}]`)?.getAttribute(i)}function W(){return(S("lang")||document.documentElement?.lang||navigator?.language||document.querySelector('meta[http-equiv="Content-Language"]')?.content)?.split(/[-_]/)?.[0]?.trim()||"en"}function le(){let e=document.documentElement;new MutationObserver(t=>{for(let a of t)a.type==="attributes"&&a.attributeName==="lang"&&H(W())}).observe(e,{attributes:!0})}async function de(){if(document.readyState!=="loading"){document.removeEventListener("readystatechange",de);let e={lang:W(),position:S("position"),offset:S("offset")?.split(",").map(Number),size:S("size")};await et(),window.WidgetPlugin=re({options:e}),S("disableObserveLang")||le()}}async function kn(){try{let e=S("backendUrl")||z.backendUrl,i=await fetch(e,{method:"GET",headers:{Accept:"application/json","Content-Type":"application/json","X-Client-Origin":window.location.origin},credentials:"include"});return i.body?(await i.json()).body===!0:(console.error("Accessibility check failed:",i.status),!1)}catch(e){return console.error("Error checking accessibility status:",e),!1}}function vn(){console.log("You are not allowed to use this widget.")}kn().then(e=>{e?document.readyState!=="loading"?de():document.addEventListener("readystatechange",de):vn()});})();

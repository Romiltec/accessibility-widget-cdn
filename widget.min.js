...
`,O=1,x=!1,h=null,f=null,I=null;function Mt(){if(!document.getElementById("asw-sr-style")){let e=document.createElement("style");e.id="asw-sr-style",e.textContent=Dt,document.head.appendChild(e)}}function Et(e){return e?.lang||document.documentElement.lang||"en-US"}function Pt(){let e=window.getSelection();return e&&e.toString().trim()?e.toString():""}function D(){if(h&&h.parentNode){let e=h.parentNode;for(;h.firstChild;)e.insertBefore(h.firstChild,h);e.removeChild(h),h=null}I&&(I.detach(),I=null)}function ye(e,i,t){if(D(),!e||!i)return;function a(c,d){c.nodeType===Node.TEXT_NODE?d.push(c):c.childNodes.forEach(p=>a(p,d))}let n=[];a(e,n);let r=0;for(let c of n){let d=c.textContent||"";if(t<r+d.length){let p=t-r,G=Math.min(p+i.length,d.length),z=document.createRange();z.setStart(c,p),z.setEnd(c,G);let j=document.createElement("span");j.className=Se,z.surroundContents(j),h=j,I=z;break}r+=d.length}}function Rt(e,i,t){if(!("speechSynthesis"in window)||!("SpeechSynthesisUtterance"in window)){alert("Text-to-speech not supported in this browser.");return}window.speechSynthesis.cancel(),D(),f=new SpeechSynthesisUtterance(e),f.lang=i,f.rate=O;let n=window.speechSynthesis.getVoices().find(r=>r.lang.startsWith(i));if(n&&(f.voice=n),f.onboundary=function(r){if(r.name==="word"&&t){let c=e.substring(r.charIndex,r.charIndex+r.charLength||0).trim();ye(t,c,r.charIndex)}},f.onend=()=>{D(),f=null},window.speechSynthesis.speak(f),!("onboundary"in f)&&t){let r=0,c=e.split(/\s+/),d=0,p=setInterval(()=>{r<c.length?(ye(t,c[r],d),d+=c[r].length+1,r++):(clearInterval(p),D())},400/O)}}function ze(e){if(!x)return;let i=e.target;if(!i||i.closest(".asw-widget"))return;let t=Pt(),a=Et(i);i instanceof HTMLImageElement&&i.alt?t=i.alt:t||(t=i.innerText||i.textContent||""),t&&Rt(t,a,i)}function ne(e=!1,i=1){Mt(),O=i,e&&!x?(x=!0,document.body.addEventListener("click",ze,!0)):!e&&x&&(x=!1,document.body.removeEventListener("click",ze,!0),window.speechSynthesis.cancel(),D())}function we(e){O=e,f&&(f.rate=e)}var oe="asw-keyboard-navigation-style",Bt=`
...
`;function je(){if(document.getElementById(oe))return;let e=document.createElement("style");e.id=oe,e.innerHTML=Bt,document.head.appendChild(e)}function Ae(){document.getElementById(oe)?.remove()}var M=!1,Gt=null;function It(e){let i=Array.from(document.querySelectorAll(e)).filter(r=>r.offsetParent!==null);if(i.length===0)return;let t=document.activeElement,a=i.indexOf(t??i[0]);a=(a+1)%i.length;let n=i[a];n.tabIndex<0&&n.setAttribute("tabindex","-1"),n.focus()}function Ce(e){if(!M)return;if(e.key==="Enter"){document.activeElement?.click?.();return}let i=e.key.toLowerCase(),t={m:'.asw-menu, nav, [role="navigation"]',h:'h1, h2, h3, h4, h5, h6, [role="heading"]',f:'form, input, select, textarea, [role="form"]',b:'button, .btn, [role="button"]',g:'img, [role="img"], .graphic'};t[i]&&(It(t[i]),Gt=i,e.preventDefault())}function He(){M||(M=!0,document.documentElement.classList.add("asw-keyboard-navigation"),je(),document.addEventListener("keydown",Ce,!0))}function Le(){M&&(M=!1,document.documentElement.classList.remove("asw-keyboard-navigation"),Ae(),document.removeEventListener("keydown",Ce,!0))}function v(){let e=l?.states;e["keyboard-navigation"]?He():Le(),X(e["highlight-title"]),ee(e["highlight-links"]),ie(e["letter-spacing"]),te(e["line-height"]),ae(e["font-weight"]),J(e["readable-font"]),Q(e["readable-guide"]),$(e["stop-animations"]),Y(e["big-cursor"]),ne(e["screen-reader"],e["screen-reader-speed"]||1)}var Fe={"dark-contrast":{styles:{color:"#FFF",fill:"#FFF","background-color":"#000"},childrenSelector:L},"light-contrast":{styles:{color:"#000",fill:"#000","background-color":"#FFF"},childrenSelector:L},"high-contrast":{styles:{filter:"contrast(125%)"}},"high-saturation":{styles:{filter:"saturate(200%)"}},"low-saturation":{styles:{filter:"saturate(50%)"}},monochrome:{styles:{filter:"grayscale(100%)"}}};function m(e){if(document.getElementById("asw-filter-style")?.remove(),document.documentElement.classList.remove("aws-filter"),!e?.length)return;let i="";for(let t of e){let a=Fe[t];a&&(i+=Z({...a,selector:"html.aws-filter"}))}T({css:i,id:"asw-filter-style"}),document.documentElement.classList.add("aws-filter")}var Te=l;function E(){F(Te.states?.fontSize??1),m(Te.states?.activeFilters??[]),v()}var xe='<div class="asw-widget"><a href="https://accessibility-widget.pages.dev" target="_blank" class="asw-menu-btn" title="Open Accessibility Menu" role="button" aria-expanded="false"><svg xmlns="http://www.w3.org/2000/svg" style="fill:white;" viewBox="0 0 24 24" width="30px" height="30px"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M20.5 6c-2.61.7-5.67 1-8.5 1s-5.89-.3-8.5-1L3 8c1.86.5 4 .83 6 1v13h2v-6h2v6h2V9c2-.17 4.14-.5 6-1l-.5-2zM12 6c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2z"/></svg></a></div>';var De=`.asw-widget,.asw-menu{-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;font-weight:400;-webkit-font-smoothing:antialiased}.asw-widget *,.asw-menu *{box-sizing:border-box!important}.asw-menu-btn{position:fixed;z-index:500000;left:30px;bottom:30px;box-shadow:0 5px 15px #252c6126,0 2px 4px #5d649433;transition:transform .2s ease;border-radius:50%;align-items:center;justify-content:center;width:58px;height:58px;display:flex;cursor:pointer;border:3px solid white!important;outline:5px solid #0048ff!important;text-decoration:none!important;background:#326cff!important;background:linear-gradient(96deg,#326cff,#0048ff)!important}.asw-menu-btn svg{width:36px;height:36px;min-height:36px;min-width:36px;max-width:36px;max-height:36px;background:transparent!important}.asw-menu-btn:hover{transform:scale(1.05)}@media only screen and (max-width: 768px){.asw-menu-btn{width:42px;height:42px}.asw-menu-btn svg{width:26px;height:26px;min-height:26px;min-width:26px;max-width:26px;max-height:26px}}
`;var Me='<div class="asw-menu"><div class="asw-menu-header"><div class="asw-menu-title asw-translate main-title"></div><div style="gap:15px;"><button type="button" class="asw-menu-reset" title="Reset settings"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M12 4c2.1 0 4.1.8 5.6 2.3 3.1 3.1 3.1 8.2 0 11.3a7.78 7.78 0 0 1-6.7 2.3l.5-2c1.7.2 3.5-.4 4.8-1.7a6.1 6.1 0 0 0 0-8.5A6.07 6.07 0 0 0 12 6v4.6l-5-5 5-5V4M6.3 17.6C3.7 15 3.3 11 5.1 7.9l1.5 1.5c-1.1 2.2-.7 5 1.2 6.8.5.5 1.1.9 1.8 1.2l-.6 2a8 8 0 0 1-2.7-1.8Z"/></svg></button> <button type="button" class="asw-menu-close" title="Close"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M19 6.41 17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12 19 6.41Z"/></svg></button></div></div><div class="asw-menu-content"><div class="asw-card"><select id="asw-language" title="Language" class="asw-select"></select></div><div class="asw-card"><div class="asw-card-title asw-translate profile-title"></div><div class="asw-profiles"></div></div><div class="asw-card"><div class="asw-card-title content-adjustments-title"></div><div class="asw-adjust-font"><div class="asw-label" style="margin:0;"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" style="margin-right:15px;"><path d="M2 4v3h5v12h3V7h5V4H2m19 5h-9v3h3v7h3v-7h3V9Z"/></svg><div class="asw-translate">Adjust Font Size</div></div><div><div class="asw-minus" data-key="font-size" role="button" aria-pressed="false" title="Decrease Font Size" tabindex="0"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M19 13H5v-2h14v2Z"/></svg></div><div class="asw-amount">100%</div><div class="asw-plus" data-key="font-size" role="button" aria-pressed="false" title="Increase Font Size" tabindex="0"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2Z"/></svg></div></div></div><div class="asw-adjust-font"><div id="asw-label-screenreader" class="asw-label"><svg style="margin-right:15px;" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 256 256" xml:space="preserve"><g><g><g><path fill="#000000" d="M135.5,43.2c-14.1,1.2-29.5,5-46.2,11.6c-5.1,2-7.1,3-7.1,3.6c0,0.4,1.7,6.8,3.7,14.2L89.5,86l3.4-0.2c1.9-0.1,8.8-0.2,15.5-0.2c12.9,0,17.6,0.5,27.8,2.8c3,0.7,5.5,1.2,5.6,1.1c0.1-0.1,3-10.5,6.3-23.1c5.3-19.6,6.1-22.9,5.5-23.2C152.5,42.6,141.3,42.7,135.5,43.2z"></path><path fill="#000000" d="M170.6,44.8c0,0.1-12.8,47.8-13.2,49.3c-0.1,0.5,0.3,0.9,1.3,1.3c2.9,1.2,13.1,6.3,16.3,8.3c8.6,5.2,16.3,11.1,22.8,17.3c3.7,3.6,3.8,3.7,4.7,2.8c3.3-3.4,43.5-49.4,43.5-49.7c0-0.6-9.3-6.1-16.9-9.9c-13.6-6.9-29.4-12.9-43.7-16.4C178,46,170.6,44.5,170.6,44.8z"></path><path fill="#000000" d="M61.4,68.4c-14,8.1-26.2,17.2-38.9,28.8C17.9,101.5,10,110,10,110.7c0,0.4,9.4,6.9,10,6.9c0.2,0,1.7-1.1,3.4-2.5c13.9-11.2,28.7-19.2,45.3-24.3c4.3-1.3,4.8-1.6,4.6-2.5c-1.6-6.2-6.2-23-6.3-23C66.8,65.4,64.3,66.8,61.4,68.4z"></path><path fill="#000000" d="M132.9,107.7c-3.4,1.5-5.6,2.8-5.8,3.3c-0.1,0.5-4.3,17.6-9.3,38c-8.9,37.1-9,37.3-10.3,37.9c-0.8,0.4-2.4,1.6-3.6,2.7c-6.9,6.3-5.4,17.5,2.9,22.1c2.3,1.3,2.9,1.4,6.7,1.4c3.8,0,4.4-0.1,6.7-1.4c6.6-3.7,9-11.6,5.6-18.5l-1.5-3.1l10.5-35.5c5.7-19.5,10.7-36.4,11.1-37.4l0.6-1.9l-3.7-5c-2-2.7-3.8-5-4-5.1C138.5,105.3,135.9,106.4,132.9,107.7z"></path></g></g></g></svg><div class="asw-card-screen-reader-speed asw-translate"></div></div><label for="asw-screenreader-speed"></label><select id="asw-screenreader-speed" class="asw-select"><option class="screen-reader-speed-low" value="0.7">Low</option><option class="screen-reader-speed-normal" value="1">Normal</option><option class="screen-reader-speed-fast" value="1.3">Fast</option></select></div><div class="asw-items content"></div></div><div class="asw-card"><div class="asw-card-title color-adjustments-title"></div><div class="asw-items contrast"></div></div><div class="asw-card"><div class="asw-card-title tools-title"></div><div class="asw-items tools"></div></div><div class="asw-card"><button type="button" class="asw-menu-reset asw-menu-reset-footer-btn asw-translate" title="Reset settings">Reset settings</button></div></div><div class="asw-footer"><p>Web Accessibility By <span style="font-weight:700;color:inherit;">Romiltec</span> \u2764\uFE0F</p></div></div>';var Ee='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="m19 19-7-8v8H5l7-8V5h7m0-2H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2Z"/></svg>';var Pe='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M11 9h2v2h-2V9m-2 2h2v2H9v-2m4 0h2v2h-2v-2m2-2h2v2h-2V9M7 9h2v2H7V9m12-6H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2M9 18H7v-2h2v2m4 0h-2v-2h2v2m4 0h-2v-2h2v2m2-7h-2v2h2v2h-2v-2h-2v2h-2v-2h-2v2H9v-2H7v2H5v-2h2v-2H5V5h14v6Z"/></svg>';var Re='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M12 16a4 4 0 0 1-4-4 4 4 0 0 1 4-4 4 4 0 0 1 4 4 4 4 0 0 1-4 4m6.7-3.6a6.06 6.06 0 0 0-.86-.4 5.98 5.98 0 0 0 3.86-5.59 6 6 0 0 0-6.78.54A5.99 5.99 0 0 0 12 .81a6 6 0 0 0-2.92 6.14A6 6 0 0 0 2.3 6.4 5.95 5.95 0 0 0 6.16 12a6 6 0 0 0-3.86 5.58 6 6 0 0 0 6.78-.54A6 6 0 0 0 12 23.19a6 6 0 0 0 2.92-6.14 6 6 0 0 0 6.78.54 5.98 5.98 0 0 0-3-5.19Z"/></svg>';var Be='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M12 18a6 6 0 0 1-6-6 6 6 0 0 1 6-6 6 6 0 0 1 6 6 6 6 0 0 1-6 6m8-2.69L23.31 12 20 8.69V4h-4.69L12 .69 8.69 4H4v4.69L.69 12 4 15.31V20h4.69L12 23.31 15.31 20H20v-4.69Z"/></svg>';var Ge='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M18 12c0-4.5-1.92-8.74-6-10a10 10 0 0 0 0 20c4.08-1.26 6-5.5 6-10Z"/></svg>';var Ie='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20zm-1 17.93a8 8 0 0 1 0-15.86v15.86zm2-15.86a8 8 0 0 1 2.87.93H13v-.93zM13 7h5.24c.25.31.48.65.68 1H13V7zm0 3h6.74c.08.33.15.66.19 1H13v-1zm0 9.93V19h2.87a8 8 0 0 1-2.87.93zM18.24 17H13v-1h5.92c-.2.35-.43.69-.68 1zm1.5-3H13v-1h6.93a8.4 8.4 0 0 1-.19 1z"/></svg>';var Oe=[{label:"Monochrome",key:"monochrome",icon:Ee},{label:"Low Saturation",key:"low-saturation",icon:Pe},{label:"High Saturation",key:"high-saturation",icon:Re},{label:"High Contrast",key:"high-contrast",icon:Ie},{label:"Light Contrast",key:"light-contrast",icon:Be},{label:"Dark Contrast",key:"dark-contrast",icon:Ge}];var Ve='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M5 4v3h5.5v12h3V7H19V4H5Z"/></svg>';var Ke='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M13.5 15.5H10v-3h3.5A1.5 1.5 0 0 1 15 14a1.5 1.5 0 0 1-1.5 1.5m-3.5-9h3A1.5 1.5 0 0 1 14.5 8 1.5 1.5 0 0 1 13 9.5h-3m5.6 1.29c.97-.68 1.65-1.79 1.65-2.79 0-2.26-1.75-4-4-4H7v14h7.04c2.1 0 3.71-1.7 3.71-3.79 0-1.52-.86-2.82-2.15-3.42Z"/></svg>';var Ne='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M21 22H3v-2h18v2m0-18H3V2h18v2m-11 9.7h4l-2-5.4-2 5.4M11.2 6h1.7l4.7 12h-2l-.9-2.6H9.4L8.5 18h-2l4.7-12Z"/></svg>';var We='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M22 3v18h-2V3h2M4 3v18H2V3h2m6 10.7h4l-2-5.4-2 5.4M11.2 6h1.7l4.7 12h-2l-.9-2.6H9.4L8.5 18h-2l4.7-12Z"/></svg>';var Ue='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="m21.59 11.59-8.09 8.09L9.83 16l-1.41 1.41 5.08 5.09L23 13M6.43 11 8.5 5.5l2.07 5.5m1.88 5h2.09L9.43 3H7.57L2.46 16h2.09l1.12-3h5.64l1.14 3Z"/></svg>';var qe='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M19 3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2m0 16H5V5h14v14m-5.06-8.94a3.37 3.37 0 0 1 0 4.75L11.73 17A3.29 3.29 0 0 1 7 17a3.31 3.31 0 0 1 0-4.74l1.35-1.36-.01.6c-.01.5.07 1 .23 1.44l.05.15-.4.41a1.6 1.6 0 0 0 0 2.28c.61.62 1.67.62 2.28 0l2.2-2.19c.3-.31.48-.72.48-1.15 0-.44-.18-.83-.48-1.14a.87.87 0 0 1 0-1.24.91.91 0 0 1 1.24 0m4.06-.7c0 .9-.35 1.74-1 2.38l-1.34 1.36v-.6c.01-.5-.07-1-.23-1.44l-.05-.14.4-.42a1.6 1.6 0 0 0 0-2.28 1.64 1.64 0 0 0-2.28 0l-2.2 2.2c-.3.3-.48.71-.48 1.14 0 .44.18.83.48 1.14.17.16.26.38.26.62s-.09.46-.26.62a.86.86 0 0 1-.62.25.88.88 0 0 1-.62-.25 3.36 3.36 0 0 1 0-4.75L12.27 7A3.31 3.31 0 0 1 17 7c.65.62 1 1.46 1 2.36Z"/></svg>';var Ze='<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><g fill="none"><path d="M24 0v24H0V0zM12.593 23.258l-.011.002-.071.035-.02.004-.014-.004-.071-.035c-.01-.004-.019-.001-.024.005l-.004.01-.017.428.005.02.01.013.104.074.015.004.012-.004.104-.074.012-.016.004-.017-.017-.427c-.002-.01-.009-.017-.017-.018m.265-.113-.013.002-.185.093-.01.01-.003.011.018.43.005.012.008.007.201.093c.012.004.023 0 .029-.008l.004-.014-.034-.614c-.003-.012-.01-.02-.02-.022m-.715.002a.023.023 0 0 0-.027.006l-.006.014-.034.614c0 .012.007.02.017.024l.015-.002.201-.093.01-.008.004-.011.017-.43-.003-.012-.01-.01z"/><path fill="#000000FF" d="M12 2.5a1.5 1.5 0 0 1 1.493 1.356L13.5 4v16a1.5 1.5 0 0 1-2.993.144L10.5 20V4A1.5 1.5 0 0 1 12 2.5m-4 3A1.5 1.5 0 0 1 9.5 7v10a1.5 1.5 0 0 1-3 0V7A1.5 1.5 0 0 1 8 5.5m8 0A1.5 1.5 0 0 1 17.5 7v10a1.5 1.5 0 0 1-3 0V7A1.5 1.5 0 0 1 16 5.5m-12 3A1.5 1.5 0 0 1 5.5 10v4a1.5 1.5 0 0 1-3 0v-4A1.5 1.5 0 0 1 4 8.5m16 0a1.5 1.5 0 0 1 1.493 1.356L21.5 10v4a1.5 1.5 0 0 1-2.993.144L18.5 14v-4A1.5 1.5 0 0 1 20 8.5"/></g></svg>';var $e=[{label:"Font Weight",key:"font-weight",icon:Ke},{label:"Line Height",key:"line-height",icon:Ne},{label:"Letter Spacing",key:"letter-spacing",icon:We},{label:"Dyslexia Font",key:"readable-font",icon:Ue},{label:"Highlight Links",key:"highlight-links",icon:qe},{label:"Highlight Title",key:"highlight-title",icon:Ve},{label:"screen-reader",key:"screen-reader",icon:Ze}];var Je='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M11 1.07C7.05 1.56 4 4.92 4 9h7m-7 6a8 8 0 0 0 8 8 8 8 0 0 0 8-8v-4H4m9-9.93V9h7a8 8 0 0 0-7-7.93Z"/></svg>';var Ye='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M22 12c0-5.54-4.46-10-10-10-1.17 0-2.3.19-3.38.56l.7 1.94A7.15 7.15 0 0 1 12 3.97 8.06 8.06 0 0 1 20.03 12 8.06 8.06 0 0 1 12 20.03 8.06 8.06 0 0 1 3.97 12c0-.94.19-1.88.53-2.72l-1.94-.66A10.37 10.37 0 0 0 2 12c0 5.54 4.46 10 10 10s10-4.46 10-10M5.47 3.97c.85 0 1.53.71 1.53 1.5C7 6.32 6.32 7 5.47 7c-.79 0-1.5-.68-1.5-1.53 0-.79.71-1.5 1.5-1.5M18 12c0-3.33-2.67-6-6-6s-6 2.67-6 6 2.67 6 6 6 6-2.67 6-6m-7-3v6H9V9m6 0v6h-2V9"/></svg>';var Xe='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M12 8a3 3 0 0 0 3-3 3 3 0 0 0-3-3 3 3 0 0 0-3 3 3 3 0 0 0 3 3m0 3.54A13.15 13.15 0 0 0 3 8v11c3.5 0 6.64 1.35 9 3.54A13.15 13.15 0 0 1 21 19V8c-3.5 0-6.64 1.35-9 3.54Z"/></svg>';var Qe=[{label:"Big Cursor",key:"big-cursor",icon:Je},{label:"Stop Animations",key:"stop-animations",icon:Ye},{label:"Reading Guide",key:"readable-guide",icon:Xe}];var rn=ue({"../locales/am.json":()=>Promise.resolve().then(()=>s(ei())),"../locales/ar.json":()=>Promise.resolve().then(()=>s(ii())),"../locales/bg.json":()=>Promise.resolve().then(()=>s(ti())),"../locales/bn.json":()=>Promise.resolve().then(()=>s(ai())),"../locales/ca.json":()=>Promise.resolve().then(()=>s(ni())),"../locales/cs.json":()=>Promise.resolve().then(()=>s(oi())),"../locales/da.json":()=>Promise.resolve().then(()=>s(si())),"../locales/de.json":()=>Promise.resolve().then(()=>s(ri())),"../locales/el.json":()=>Promise.resolve().then(()=>s(li())),"../locales/en.json":()=>Promise.resolve().then(()=>s(di())),"../locales/es.json":()=>Promise.resolve().then(()=>s(ci())),"../locales/fa.json":()=>Promise.resolve().then(()=>s(ui())),"../locales/fi.json":()=>Promise.resolve().then(()=>s(pi())),"../locales/fil.json":()=>Promise.resolve().then(()=>s(gi())),"../locales/fr.json":()=>Promise.resolve().then(()=>s(fi())),"../locales/he.json":()=>Promise.resolve().then(()=>s(_i())),"../locales/hi.json":()=>Promise.resolve().then(()=>s(mi())),"../locales/hr.json":()=>Promise.resolve().then(()=>s(bi())),"../locales/hu.json":()=>Promise.resolve().then(()=>s(hi())),"../locales/id.json":()=>Promise.resolve().then(()=>s(ki())),"../locales/it.json":()=>Promise.resolve().then(()=>s(vi())),"../locales/ja.json":()=>Promise.resolve().then(()=>s(yi())),"../locales/ka.json":()=>Promise.resolve().then(()=>s(zi())),"../locales/kn.json":()=>Promise.resolve().then(()=>s(Si())),"../locales/ko.json":()=>Promise.resolve().then(()=>s(wi())),"../locales/ku.json":()=>Promise.resolve().then(()=>s(ji())),"../locales/lb.json":()=>Promise.resolve().then(()=>s(Ai())),"../locales/ml.json":()=>Promise.resolve().then(()=>s(Ci())),"../locales/mn.json":()=>Promise.resolve().then(()=>s(Hi())),"../locales/ms.json":()=>Promise.resolve().then(()=>s(Li())),"../locales/my.json":()=>Promise.resolve().then(()=>s(Fi())),"../locales/nl.json":()=>Promise.resolve().then(()=>s(Ti())),"../locales/no.json":()=>Promise.resolve().then(()=>s(xi())),"../locales/pa.json":()=>Promise.resolve().then(()=>s(Di())),"../locales/pl.json":()=>Promise.resolve().then(()=>s(Mi())),"../locales/pt.json":()=>Promise.resolve().then(()=>s(Ei())),"../locales/ro.json":()=>Promise.resolve().then(()=>s(Pi())),"../locales/ru.json":()=>Promise.resolve().then(()=>s(Ri())),"../locales/si.json":()=>Promise.resolve().then(()=>s(Bi())),"../locales/sk.json":()=>Promise.resolve().then(()=>s(Gi())),"../locales/sl.json":()=>Promise.resolve().then(()=>s(Ii())),"../locales/sr-SP.json":()=>Promise.resolve().then(()=>s(Oi())),"../locales/sr.json":()=>Promise.resolve().then(()=>s(Vi())),"../locales/sv.json":()=>Promise.resolve().then(()=>s(Ki())),"../locales/sw.json":()=>Promise.resolve().then(()=>s(Ni())),"../locales/ta.json":()=>Promise.resolve().then(()=>s(Wi())),"../locales/te.json":()=>Promise.resolve().then(()=>s(Ui())),"../locales/th.json":()=>Promise.resolve().then(()=>s(qi())),"../locales/tr.json":()=>Promise.resolve().then(()=>s(Zi())),"../locales/uk.json":()=>Promise.resolve().then(()=>s($i())),"../locales/ur.json":()=>Promise.resolve().then(()=>s(Ji())),"../locales/vi.json":()=>Promise.resolve().then(()=>s(Yi())),"../locales/zh-Hans.json":()=>Promise.resolve().then(()=>s(Xi())),"../locales/zh-Hant.json":()=>Promise.resolve().then(()=>s(Qi()))});var A=[{code:"am",label:"\u12A0\u121B\u122D\u129B (Amharic)"},{code:"ar",label:"\u0627\u0644\u0639\u0631\u0628\u064A\u0629 (Arabic)"},{code:"bg",label:"\u0431\u044A\u043B\u0433\u0430\u0440\u0441\u043A\u0438 (Bulgarian)"},{code:"bn",label:"\u09AC\u09BE\u0982\u09B2\u09BE (Bengali)"},{code:"ca",label:"Catal\xE0 (Catalan)"},{code:"cs",label:"\u010De\u0161tina (Czech)"},{code:"da",label:"Danish (Denmark)"},{code:"de",label:"Deutsch (German)"},{code:"el",label:"\u0395\u03BB\u03BB\u03B7\u03BD\u03B9\u03BA\u03AC (Greek)"},{code:"en",label:"English (English)"},{code:"es",label:"Espa\xF1ol (Spanish)"},{code:"fa",label:"\u0641\u0627\u0631\u0633\u06CC (Persian)"},{code:"fi",label:"suomi (Finnish)"},{code:"fil",label:"Tagalog (Filipno)"},{code:"fr",label:"Fran\xE7ais (French)"},{code:"he",label:"\u05E2\u05D1\u05E8\u05D9\u05EA (Hebrew)"},{code:"hi",label:"\u0939\u093F\u0928\u094D\u0926\u0940 (Hindi)"},{code:"hr",label:"Hrvatski (Croatian)"},{code:"hu",label:"Magyar (Hungarian)"},{code:"id",label:"Bahasa Indonesia (Indonesian)"},{code:"it",label:"Italiano (Italian)"},{code:"ja",label:"\u65E5\u672C\u8A9E (Japanese)"},{code:"ka",label:"\u10E5\u10D0\u10E0\u10D7\u10E3\u10DA\u10D8 (Georgian)"},{code:"kn",label:"\u0C95\u0CA8\u0CCD\u0CA8\u0CA1 (Kannada)"},{code:"ko",label:"\uD55C\uAD6D\uC5B4 (Korean)"},{code:"ku",label:"Kurd\xEE (Kurdish)"},{code:"lb",label:"L\xEBtzebuergesch (Luxembourgish)"},{code:"ml",label:"\u0D2E\u0D32\u0D2F\u0D3E\u0D33\u0D02 (Malayalam)"},{code:"mn",label:"\u041C\u043E\u043D\u0433\u043E\u043B (Mongolian)"},{code:"ms",label:"Bahasa Malaysia (Malay)"},{code:"my",label:"\u1019\u103C\u1014\u103A\u1019\u102C (Burmese)"},{code:"nl",label:"Nederlands (Dutch)"},{code:"no",label:"Norsk (Norwegian)"},{code:"pa",label:"\u0A2A\u0A70\u0A1C\u0A3E\u0A2C\u0A40 (Punjabi)"},{code:"pl",label:"Polski (Polish)"},{code:"pt",label:"Portugu\xEAs (Portuguese)"},{code:"ro",label:"Rom\xE2n\u0103 (Romanian)"},{code:"si",label:"Sloven\u0161\u010Dina (Slovene)"},{code:"sk",label:"sloven\u010Dina (Slovak)"},{code:"sl",label:"sloven\u0161\u010Dina (Slovenian)"},{code:"sr",label:"Srpski (Serbian)"},{code:"sr-SP",label:"\u0421\u0440\u043F\u0441\u043A\u0438 (Serbian Cyrillic)"},{code:"sv",label:"Svenska (Swedish)"},{code:"sw",label:"Kiswahili (Swahili)"},{code:"ta",label:"\u0BA4\u0BAE\u0BBF\u0BB4\u0BCD (Tamil)"},{code:"te",label:"\u0C24\u0C46\u0C32\u0C41\u0C17\u0C41 (Telugu)"},{code:"th",label:"\u0E44\u0E17\u0E22 (Thai)"},{code:"tr",label:"T\xFCrk\xE7e (Turkish)"},{code:"ur",label:"\u0627\u0631\u062F\u0648 (Urdu)"},{code:"uk",label:"\u0423\u043A\u0440\u0430\u0457\u043D\u0441\u044C\u043A\u0430 (Ukrainian)"},{code:"vi",label:"Ti\u1EBFng Vi\u1EC7t (Vietnamese)"},{code:"zh-Hans",label:"\u7B80\u4F53\u4E2D\u6587 (Simplified Chinese)"},{code:"zh-Hant",label:"\u7E41\u9AD4\u4E2D\u6587 (Traditional Chinese)"}],ln=A.map(e=>e.code),V={};async function et(){for(let e of ln)V[e]=(await rn(`../locales/${e}.json`)).default}function b(e){return(V[l.lang]??V.en)[e]??e}function P(e,i){return e.slice().reverse().map(t=>`<button class="asw-btn ${i||""}" type="button" data-key="${t.key}" title="${b(t.label)}">
                ${t.icon}<span class="asw-translate">${b(t.label)}</span>
            </button>`).join("")}function y(e,i){let t=i.states.activeFilters||[];e.querySelectorAll(".asw-filter").forEach(a=>{let n=a.dataset.key;Array.isArray(t)&&t.includes(n)?a.classList.add("asw-selected"):a.classList.remove("asw-selected")}),e.querySelectorAll(".asw-content").forEach(a=>{let n=a.dataset.key;i.states[n]?a.classList.add("asw-selected"):a.classList.remove("asw-selected")}),e.querySelectorAll(".asw-tools").forEach(a=>{let n=a.dataset.key;i.states[n]?a.classList.add("asw-selected"):a.classList.remove("asw-selected")})}function se(){l.states={"screen-reader-speed":1,activeFilters:[]},delete l.states["active-profile"],E(),m([]),g();let e=document.querySelector(".asw-menu");e&&y(e,l)}var R=[{id:"seizure-safe",title:"seizure_safe_profile_title",subtitle:"seizure_safe_profile_subtitle",desc:"seizure_safe_profile_desc",features:{filters:["low-saturation"],"stop-animations":!0}},{id:"vision-impaired",title:"vision_impaired_profile_title",subtitle:"vision_impaired_profile_subtitle",desc:"vision_impaired_profile_desc",features:{"font-weight":!0,filters:["high-saturation"]}},{id:"adhd-friendly",title:"adhd_friendly_profile_title",subtitle:"adhd_friendly_profile_subtitle",desc:"adhd_friendly_profile_desc",features:{filters:["high-saturation"],"stop-animations":!0,"readable-guide":!0,fontSize:1.1}},{id:"cognitive-disability",title:"cognitive_disability_profile_title",subtitle:"cognitive_disability_profile_subtitle",desc:"cognitive_disability_profile_desc",features:{"highlight-title":!0,"highlight-links":!0,"stop-animations":!0,fontSize:1.1}},{id:"keyboard-navigation",title:"keyboard_navigation_profile_title",subtitle:"keyboard_navigation_profile_subtitle",desc:"keyboard_navigation_profile_desc",features:{"keyboard-navigation":!0}}];function it(){"renderMenu"in window&&typeof window.renderMenu=="function"&&window.renderMenu()}function dn(){let e=new Set;return R.forEach(i=>{Object.keys(i.features).forEach(t=>{t!=="filters"&&e.add(t)})}),Array.from(e)}function tt(e,i,t,a,n,r){let c=R.find(d=>d.id===e);c&&(dn().forEach(d=>{delete i.states[d]}),i.states.activeFilters=c.features.filters||[],r?.(i.states.activeFilters),Object.entries(c.features).forEach(([d,p])=>{d!=="filters"&&(i.states[d]=p)}),i.states["active-profile"]=e,a(),t(),it(),n?.(e))}function at(e,i,t,a,n,r){let c=R.find(d=>d.id===e);c&&(i.states.activeFilters=[],r?.([]),Object.keys(c.features).forEach(d=>{d!=="filters"&&delete i.states[d]}),delete i.states["active-profile"],a(),t(),it(),n?.(e))}var nt=`.asw-menu{position:fixed;display:flex;flex-direction:column;left:0;top:0;box-shadow:0 0 20px #00000080;opacity:1;transition:.3s;z-index:500000;overflow:hidden;background:#eff1f5;width:500px;line-height:1;font-size:16px;height:100%;letter-spacing:.015em}.asw-menu--hidden{display:none!important}button:focus,[role=button]:focus,.btn:focus{box-shadow:0 0 0 2px #1976d233,0 0 8px #1976d266}input:focus,select:focus,textarea:focus{box-shadow:0 0 0 2px #1976d233,0 0 8px #1976d266}.asw-menu *{color:#000!important;font-family:inherit;padding:0;margin:0;line-height:1!important;letter-spacing:normal!important}.asw-menu-header{display:flex;align-items:center;justify-content:space-between;padding:10px 15px;height:55px;font-weight:700!important;background-color:#0848ca!important}.asw-menu-title{font-size:16px!important;color:#fff!important}.asw-menu-header svg{fill:#0848ca!important;width:24px!important;height:24px!important;min-width:24px!important;min-height:24px!important;max-width:24px!important;max-height:24px!important}.asw-menu-header>div{display:flex}.asw-menu-reset,.asw-menu-close{padding:5px!important;margin:0!important;background:#fff!important;cursor:pointer!important;border-radius:50%!important;transition:opacity .3s ease!important;border:0!important;box-shadow:none!important;outline:none!important}.asw-menu-reset-footer-btn{border-radius:5px!important;width:100%!important;font-size:15px!important;font-weight:600!important;padding:15px!important;background:#0848ca!important;color:#fff!important}.asw-menu-reset:hover,.asw-menu-close:hover,.asw-menu-reset:focus,.asw-menu-close:focus,.asw-menu-reset-footer-btn:hover,.asw-menu-reset-footer-btn:focus{outline:3px solid hsla(0,0%,100%,.4)!important}.asw-card{margin:0 15px 20px}.asw-card-title{font-size:14px!important;padding:15px 0;font-weight:600!important;opacity:.8}.asw-menu .asw-select{width:100%!important;padding:0 15px!important;font-size:16px!important;font-family:inherit!important;font-weight:600!important;border-radius:45px!important;background:#fff!important;border:none!important;min-height:45px!important;max-height:45px!important;height:45px!important;color:inherit!important;&#asw-screenreader-speed{background:#eff1f5!important}}.asw-items{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:1rem}.asw-btn{aspect-ratio:6 / 5;border-radius:12px;padding:0 15px;display:flex;align-items:center;justify-content:center;flex-direction:column;text-align:center;color:#333;font-size:16px!important;background:#fff!important;border:2px solid transparent!important;transition:border-color .2s ease;cursor:pointer;word-break:break-word;gap:10px;position:relative;width:auto!important;height:auto!important}.asw-btn .asw-translate,.asw-adjust-font .asw-label div{font-size:14px!important;font-weight:600!important}.asw-plus,.asw-minus{background-color:#eff1f5!important;border:2px solid transparent;transition:border .2s ease}.asw-plus:hover,.asw-minus:hover{border-color:#0848ca!important}.asw-amount{font-size:18px!important;font-weight:600!important}.asw-adjust-font svg{width:24px!important;height:24px!important;min-width:24px!important;min-height:24px!important;max-width:24px!important;max-height:24px!important}.asw-btn svg{width:34px!important;height:34px!important;min-width:34px!important;min-height:34px!important;max-width:34px!important;max-height:34px!important}.asw-btn:hover,.asw-btn.asw-selected{border-color:#0848ca!important}.asw-btn.asw-selected svg,.asw-btn.asw-selected span{fill:#0848ca!important;color:#0848ca!important}.asw-btn.asw-selected:after{content:"";display:inline-block;background-image:url(data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20height%3D%2224px%22%20viewBox%3D%220%20-960%20960%20960%22%20width%3D%2224px%22%20fill%3D%22%23fff%22%3E%3Cpath%20d%3D%22M382-240%20154-468l57-57%20171%20171%20367-367%2057%2057-424%20424Z%22%2F%3E%3C%2Fsvg%3E);background-size:contain;background-repeat:no-repeat;position:absolute;top:10px;right:10px;background-color:#0848ca!important;color:#fff;padding:6px;font-size:10px;width:18px;height:18px;border-radius:100%;line-height:6px}.asw-footer{bottom:0;left:0;right:0;background:#fff;padding:20px;text-align:center;border-top:2px solid #eff1f5}.asw-footer a{font-size:16px!important;text-decoration:none!important;color:#000!important;background:transparent!important;font-weight:600!important}.asw-footer a:hover,.asw-footer a:hover span{color:#0848ca!important}.asw-menu-content{flex:1;overflow-y:scroll;overflow-x:hidden;padding:30px 0 15px}.asw-adjust-font{background:#fff;padding:20px;margin-bottom:20px}.asw-adjust-font .asw-label{display:flex;justify-content:flex-start;&#asw-label-screenreader{margin-bottom:20px}}.asw-adjust-font>div{display:flex;justify-content:space-between;margin-top:20px;align-items:center;font-size:15px}.asw-adjust-font .asw-label div{font-size:15px!important}.asw-adjust-font div[role=button]{background:#eff1f5!important;border-radius:50%;width:36px;height:36px;display:flex;align-items:center;justify-content:center;cursor:pointer}.asw-profiles{display:flex;flex-direction:column;gap:18px;margin-bottom:20px}.asw-profile{background:#fff;border-radius:12px;box-shadow:0 0 4px #0001;padding:16px 20px;position:relative;transition:box-shadow .2s}.asw-profile-header{display:flex;justify-content:space-between;align-items:center;font-size:17px;font-weight:600}.asw-profile-title{color:#0848ca}.asw-profile-toggle{background:#eee;border-radius:16px;padding:2px 16px;cursor:pointer;font-weight:600;color:#333;border:2px solid #ccc;transition:background .2s,border .2s;user-select:none}.asw-profile-toggle.on{background:#0848ca;color:#fff;border:2px solid #0848ca}.asw-profile-subtitle{font-size:14px;color:#666;margin-top:4px}.asw-profile-desc{font-size:13px;margin-top:8px;color:#444;background:#f4f8ff;border-radius:8px;padding:10px 13px;display:none;line-height:1.2!important}.asw-profile.active .asw-profile-desc{display:block}@media only screen and (max-width: 560px){.asw-menu{width:100%}}@media only screen and (max-width: 420px){.asw-items{grid-template-columns:repeat(2,minmax(0,1fr));gap:.5rem}}
`;var C={lang:"en",position:"bottom-left",offset:[20,20],size:58};function ot(e,i){let t=e.getAttribute("data-translate")||i;return!e.hasAttribute("data-translate")&&i&&e.setAttribute("data-translate",t),b(t)}function S(){_.querySelectorAll(".asw-card-title, .asw-translate").forEach(e=>{let i=e.textContent?.trim()||"";e.textContent=ot(e,i)}),_.querySelectorAll("[title]").forEach(e=>{let i=e.getAttribute("title")||"";e.setAttribute("title",ot(e,i))})}function H(e){if(e=String(e||"").toLowerCase(),A.some(i=>i.code===e)||(e="en"),l.lang!==e){l.lang=e;let i=K.querySelector("#asw-language");i&&(i.value=e),S(),g()}}function B(){let e=document.querySelector(".asw-menu");e&&e.classList.toggle("asw-menu--hidden")}function un(e){C?.position?.includes("right")&&(e.style.right="0px",e.style.left="auto")}function st(e,i){let t=e.querySelector(".asw-amount");t&&(t.textContent=`${(i*100).toFixed(0)}%`)}function pn(e){e.innerHTML=A.map(i=>`<option value="${i.code}">${i.label}</option>`).join(""),e.value=l.lang}function gn(e,i){let a=l?.states?.fontSize??1;a+=i.classList.contains("asw-minus")?-.1:.1,a=Math.max(.1,Math.min(2,Number(a.toFixed(2)))),st(e,a),F(a),l.states.fontSize=a,g(),y(e,l)}function fn(e,i){let t=i.dataset.key;if(i.classList.contains("asw-filter")){let n=l.states.activeFilters??[];n=Array.isArray(n)?n:[],n=n.includes(t)?n.filter(r=>r!==t):[...n,t],l.states.activeFilters=n,m(n),g(),v(),y(e,l);return}let a=!l.states[t];l.states[t]=a,v(),g(),y(e,l)}function _n(e,i){i.value=l.states["screen-reader-speed"]?.toString()??"1",i.addEventListener("change",t=>{let a=t.target.value;l.states["screen-reader-speed"]=Number(a),g(),we(Number(a)),y(e,l)})}function mn(e){e.innerHTML=R.map(i=>{let t=l.states["active-profile"]===i.id;return`
    ...
    `}).join(""),e.querySelectorAll(".asw-profile-toggle").forEach(i=>{i.addEventListener("click",function(){let a=i.closest(".asw-profile").getAttribute("data-id");l.states["active-profile"]===a?at(a,l,v,g,null,m):tt(a,l,v,g,null,m)})})}function bn(e,i){e.querySelectorAll(".asw-menu-close").forEach(t=>t.addEventListener("click",B)),e.querySelectorAll(".asw-menu-reset, .asw-menu-reset-footer-btn").forEach(t=>t.addEventListener("click",()=>{se(),N()})),i.querySelectorAll(".asw-plus, .asw-minus").forEach(t=>t.addEventListener("click",()=>gn(i,t))),i.querySelectorAll(".asw-btn").forEach(t=>t.addEventListener("click",()=>fn(i,t)))}function N(){document.querySelector(".asw-menu")?.remove();let e=document.createElement("div");e.innerHTML=`<style>${nt}</style>`+Me;let i=e.querySelector(".asw-menu");un(i),i.querySelector(".content").innerHTML=P($e,"asw-content"),i.querySelector(".tools").innerHTML=P(Qe,"asw-tools"),i.querySelector(".contrast").innerHTML=P(Oe,"asw-filter");let t=Number(l.states?.fontSize)||1;st(i,t),A.some(d=>d.code===l.lang)||(l.lang="en");let a=i.querySelector("#asw-language");pn(a),a.addEventListener("change",d=>{H(d.target.value),N()}),bn(e,i);let n=i.querySelector("#asw-screenreader-speed");n&&_n(i,n);let r=i.querySelector(".asw-profiles");return mn(r),[{selector:".asw-menu-title.asw-translate.main-title",key:"accessibility_menu"},{selector:".asw-card-title.asw-translate.profile-title",key:"accessibility_profiles"},{selector:".asw-card-title.content-adjustments-title",key:"Content Adjustments"},{selector:".asw-card-title.color-adjustments-title",key:"Color Adjustments"},{selector:".asw-card-title.tools-title",key:"Tools"},{selector:".asw-card-screen-reader-speed.asw-translate",key:"screen-reader-speed"},{selector:".asw-label .asw-translate",key:"Adjust Font Size"},{selector:".asw-menu-reset-footer-btn",key:"Reset settings"},{selector:".screen-reader-speed-low",key:"screen_reader_speed_low",title:"Low"},{selector:".screen-reader-speed-normal",key:"screen_reader_speed_normal",title:"Normal"},{selector:".screen-reader-speed-fast",key:"screen_reader_speed_fast",title:"Fast"}].forEach(({selector:d,key:p,title:G})=>{let z=i.querySelector(d);if(z){let j=b(p);z.textContent=j===p&&G?G:j}}),_.appendChild(e),m(l.states.activeFilters??[]),y(i,l),e}window.renderMenu=N;var rt=N;var K;function lt(){K?B():K=rt(),S()}var _;function dt(){_=document.createElement("div"),_.classList.add("asw-container"),_.innerHTML=`<style>${De}</style>${xe}`;let e=_.querySelector(".asw-menu-btn");return Object.assign(e.style,hn()),e?.addEventListener("click",i=>{i.preventDefault(),i.stopPropagation(),i.stopImmediatePropagation(),lt()}),S(),document.body.appendChild(_),_}function hn(){let{position:e="bottom-left",offset:i=[20,20]}=C,[t=20,a=25]=i,n=`calc(50% - 27.5px - ${a}px)`,r=`calc(50% - 27.5px - ${t}px)`;switch(e){case"bottom-right":return{bottom:`${a}px`,right:`${t}px`,left:"auto"};case"top-left":return{top:`${a}px`,left:`${t}px`,bottom:"auto"};case"top-right":return{top:`${a}px`,right:`${t}px`,left:"auto",bottom:"auto"};case"center-left":return{left:`${t}px`,bottom:n};case"center-right":return{right:`${t}px`,left:"auto",bottom:n};case"bottom-center":return{bottom:`${a}px`,left:r};case"top-center":return{top:`${a}px`,bottom:"auto",left:r};default:return{bottom:`${a}px`,left:`${t}px`}}}function re({options:e}){let i=he();return Object.assign(C,e),Object.assign(l,i),E(),dt(),{changeLanguage:H}}function w(e){let i=`data-asw-${e}`,t=document.currentScript;return t?.hasAttribute(i)?t.getAttribute(i):document.querySelector(`[${i}]`)?.getAttribute(i)}function W(){return(w("lang")||document.documentElement?.lang||navigator?.language||document.querySelector('meta[http-equiv="Content-Language"]')?.content)?.split(/[-_]/)?.[0]?.trim()||"en"}function le(){let e=document.documentElement;new MutationObserver(t=>{for(let a of t)a.type==="attributes"&&a.attributeName==="lang"&&H(W())}).observe(e,{attributes:!0})}async function de(){if(document.readyState!=="loading"){document.removeEventListener("readystatechange",de);let e={lang:W(),position:w("position"),offset:w("offset")?.split(",").map(Number),size:w("size")};await et(),window.WidgetPlugin=re({options:e}),w("disableObserveLang")||le()}}function kn(){return!0}function vn(){let e=()=>{if(!document.body)return setTimeout(e,200);if(!document.getElementById("not-allowed-widget-message")){let i=document.createElement("div");Object.assign(i,{id:"not-allowed-widget-message",textContent:"You are not allowed to use accessibility widget."}),Object.assign(i.style,{position:"fixed",top:"0",left:"0",width:"100vw",background:"#ffebee",color:"#c62828",fontSize:"1.5rem",textAlign:"center",zIndex:"99999",padding:"1em",display:"block",boxShadow:"0 2px 8px rgba(0,0,0,0.15)"}),document.body.appendChild(i)}};e()}kn()?document.readyState!=="loading"?de():document.addEventListener("readystatechange",de):vn();})();
